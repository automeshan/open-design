...
> 🔥 **`0.8.0-preview` is here. Design's old world ends here.** An open, agent-native alternative to Figma — 40k stars in two weeks got us this far. **We need you to push the rest of the way.** → [**Read the announcement, grab the installer, join the movement**](https://github.com/nexu-io/open-design/discussions/1727) · runs side-by-side with your current 0.7.
